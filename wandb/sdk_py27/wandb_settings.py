...
class Settings(object):
    ...
    # Private attributes
    __COMMENT____start_time: Optional[float]
    __COMMENT____start_datetime: Optional[datetime]

    # Internal attributes
    __COMMENT____frozen: bool
    __COMMENT____defaults_dict: Dict[str, int]
    __COMMENT____override_dict: Dict[str, int]
    __COMMENT____defaults_dict_set: Dict[str, Set[int]]
    __COMMENT____override_dict_set: Dict[str, Set[int]]
